...
you can also follow this tuto to get the aws layer
Cloud9:
 # For Linux, py 3.8 installation: 
  ...
  # Directly we can create the layer with this zip file 
   aws lambda publish-layer-version --layer-name psyco-layer --zip-file fileb://layer.zip --compatible-runtimes python3.8 --region eu-west-3   
